package com.huixin.framework.utils.ali.pay.util;
...
import com.huixin.framework.utils.ali.pay.config.AlipayConfig;
import com.huixin.framework.utils.ali.pay.sign.Base64;
...
public class AlipayCore {
	...
	public static String sign(String content, String privateKey) throws BusinessException {
		try {
			...
			e.printStackTrace();
			throw new BusinessException("error", "签名出错", content);
		}
	}
	 ...
	 * 
	 */
	public static String getOrderInfo(String subject, String body, String price, String orderCode) {
		// 合作者身份ID
		...
		// 服务器异步通知页面路径
		orderInfo += "&notify_url=" + "\"" + PropertiesUtil.getValue("wechat.properties", "ali_callback") + "\"";
