...
public class DateUtil {
	 ...
	 * @return
	 */
	public static Date fomatDate(String date, String parse) {
		DateFormat fmt = new SimpleDateFormat(parse);
		try {
			return fmt.parse(date);
		} catch (ParseException e) {
			e.printStackTrace();
	...
	public static void main(String[] args) throws ParseException {
		...
		// System.out.println(DateUtil.getHourDifference(System.currentTimeMillis(),
		// 1447670390443l));
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
		String d = "2016-07-14 18:14";
