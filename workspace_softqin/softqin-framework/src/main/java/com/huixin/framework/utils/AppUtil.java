...
public class AppUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println("jsoncallback".contains("callback"));
	}
	...
	public static boolean checkParam(String method, PageData pd) {
		...
		} else if ("loginAppUser".equals(method)) {// 根据用户名获取会员信息
			paramArray = Const.APP_LOGINAPPUSER_PARAM_ARRAY;
			valueArray = Const.APP_LOGINPPUSER_VALUE_ARRAY;
		}
	...
	public static Object returnObject(PageData pd, Map map) {
		if (!StringUtils.isEmpty(pd.get("callback"))) {
