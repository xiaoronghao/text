package com.huixin.framework.utils.token;
...
public class Jwt {
	...
	public static void main(String[] args) {
		...
		pd.put("USER_ID", "ADAE9AEE519A8426C8DADA66E9EAA1E2");
		System.out.println(putToken(pd));
	}
	
	public static String putToken(PageData pd) {
		Map<String, Object> payload = new HashMap<String, Object>();
		Date date = new Date();
		payload.put("uid", pd.getString("USER_ID"));// 用户id
