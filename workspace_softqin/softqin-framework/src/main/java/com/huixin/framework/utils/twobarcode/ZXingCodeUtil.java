package com.huixin.framework.utils.twobarcode;
...
public class ZXingCodeUtil {
    ...
    public static void main(String[] args) throws WriterException {
    	String content = "kjfdshfdsfkjdshfkjhdskjhnjkcxnjhejdnhfcjshjfjdshfjhdsfjhdsjfhkjdshfkjdshfkjhdskjfhdskjfhdskjfhkjdhfkjdkjhfjkdhfkjhdfjkhdkjf";
        System.out.println("inputParam“:" + content);
        try {
            // 生成二维码
            File file = new File("E:/haidong4.png");
            ...
            zxingconfig.setLogoPath("E:/1.png"); // 设置Logo图片
