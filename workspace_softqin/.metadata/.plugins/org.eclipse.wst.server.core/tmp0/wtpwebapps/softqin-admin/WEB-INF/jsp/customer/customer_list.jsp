				...
				<tr>
					...
					<td>
						<span class="input-icon">
							<input autocomplete="off" id="nav-search-input" type="text" name="name" value="${pd.name }" placeholder="这里输入客户名" />
					...
					<c:when test="${not empty customerList}">
						...
						<c:forEach items="${customerList}" var="var" varStatus="vs">
							...
							<tr>
								...
								<td>${var.content }</td>
								<td>
								<fmt:formatDate value="${var.register_date }" pattern="yyyy-MM-dd" />
								</td>
