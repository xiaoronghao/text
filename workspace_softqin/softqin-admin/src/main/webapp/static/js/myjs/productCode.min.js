...
function saveD() {
	var dname = $("#dname").val().toLowerCase();
	var dtype = $("#dtype").val();
	var dbz = $("#dbz").val();
	...
	var fields = dname + ",huixin.haidong," + dtype + ",huixin.haidong," + dbz
			+ ",huixin.haidong," + isQian + ",huixin.haidong," + ddefault;
	if (msgIndex == "") {
		arrayField(fields)
	} else {
...
function editField(value, msgIndex) {
	var efieldarray = value.split(",huixin.haidong,");
...
function appendC(value) {
	var fieldarray = value.split(",huixin.haidong,");
	$("#fields")
			.append(
					"<tr>" + '<td class="center">'
							+ fieldarray[0]
...
function isSame(value) {
	for (var i = 0; i < arField.length; i++) {
		var array0 = arField[i].split(",huixin.haidong,")[0];
		if (array0 == value) {
			return false
		}
	}
