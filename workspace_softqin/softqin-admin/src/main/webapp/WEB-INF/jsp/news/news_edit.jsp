...
<script type="text/javascript">
	...
	function delP(tpurl,id){
		 if(confirm("确定要删除图片？")){
			var url = "<%=basePath%>news/deltp.do?tpurl="+tpurl+"&id="+id+"&guid="+new Date().getTime();
...
<body>
	<form action="news/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td>简介:</td>
				<td><input type="text" style="width:95%;" name="introduction" id="introduction" value="${pd.introduction }" placeholder="这里输入简介" title="简介"/></td>
			</tr>
			<tr>
				<td>内容:</td>
				<td id="nr">
			...
			<tr>
				<td>出版时间:</td>
				<td>
					<input style="width:35%;" class="span10 date-picker" name="publish_date" id="publish_date" value="${pd.publish_date}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="出版日期" title="出版日期"/>
				</td>
			</tr>
			<tr>
				<td>更新时间:</td>
				<td>
					<input style="width:35%;" class="span10 date-picker" name="update_date" id="update_date" value="${pd.update_date}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="更新日期" title="更新日期"/>
				</td>
			</tr>
